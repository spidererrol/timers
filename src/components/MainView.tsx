...
export function MainView({ timers, addTimer, delTimer, updateTimer, ShowExporter, ShowImporter }: { timers: TimerData[]; addTimer: () => void; delTimer: (id: number) => void; updateTimer: (id: number, update: (timer: TimerData) => void) => void; ShowExporter: tState; ShowImporter: tState }) {
