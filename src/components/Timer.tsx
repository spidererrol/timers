...
export default function Timer({ timer, copyTimer, delTimer, updateTimer, dragging }: { timer: TimerData, copyTimer: () => void, delTimer: (id: number) => void, updateTimer: updateTimerFunction, dragging: boolean }) {
    if (timer.configured) {
